...
def create_app(config=config_dict['dev']):
    ...
    db.init_app(app)
    api=Api(app,title="OnePeace administration panel",description="Api for project mobile application ",contact_email="onepeace2023@gmail.com")
    mail.init_app(app)
    ...
    class FileView(FileAdmin):
        ...
        can_download=True
    path="C:/Users/yosser/Documents/GitHub/OnePeace PFE/onepeace-backend/api/uploads"
